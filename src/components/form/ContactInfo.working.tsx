...
const getContactIcon = (channelTypeId: string) => {
  switch (channelTypeId) {
    case "1": return DevicePhoneMobileIcon;
    case "2": return AtSymbolIcon;
    case "3": case "4": return ChatBubbleLeftRightIcon;
...
// Contact type label override mapping
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Input
              placeholder={channelType?.value === "2" ? "email@example.com" : "(+855) 012-345-678"}
